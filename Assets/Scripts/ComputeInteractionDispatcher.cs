...
namespace DefaultNamespace
{
    ...
    public class ComputeInteractionDispatcher
    {
        ...
        public void DispatchDrawCircle(SwappableComputeBuffer<Particle> particleBuffer,SwappableComputeBuffer<ParticleConnection> connectionBuffer,ComputeBuffer particleIndexPool,ComputeBuffer connectionIndexPool)
        {
            ...
            this.computeShader.SetBuffer(DrawCircleId,"particleIndexPool",particleIndexPool);
            this.computeShader.SetBuffer(DrawCircleId,"connectionIndexPool",connectionIndexPool);
